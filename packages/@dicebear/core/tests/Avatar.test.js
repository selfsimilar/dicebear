...
describe('Avatar', () => {
  ...
  it('toString #1', () => {
    ...
    assert.strictEqual(
      avatar.toString(),
      `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><metadata xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/"><rdf:RDF><rdf:Description><dc:title>DiceBear</dc:title><dc:creator>DiceBear</dc:creator><dc:source xsi:type="dcterms:URI">https://www.dicebear.com</dc:source><dcterms:license xsi:type="dcterms:URI">https://creativecommons.org/publicdomain/zero/1.0/</dcterms:license><dc:rights>„DiceBear” (https://www.dicebear.com) by „DiceBear”, licensed under „CC0 1.0” (https://creativecommons.org/publicdomain/zero/1.0/)</dc:rights></rdf:Description></rdf:RDF></metadata><mask id="viewboxMask"><rect width="100" height="100" rx="0" ry="0" fill="#fff" /></mask><g mask="url(#viewboxMask)"><rect fill="rgba(42, 126, 126, 1)" width="100" height="100" /><g transform="rotate(360 50 50)"><defs><linearGradient id="color-text"><stop stop-color="rgba(255, 255, 255, 1)"/></linearGradient></defs><text x="50%" y="50%" font-family="system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', 'Noto Sans', 'Liberation Sans', Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji'" font-size="50" fill="url(#color-text)" text-anchor="middle" dy="17.8">JD</text></g></g></svg>`,
    );
  });
  ...
  it('toString #2', () => {
    ...
    assert.strictEqual(
      avatar.toString(),
      '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1 1"><metadata xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/"><rdf:RDF><rdf:Description><dc:rights>Design by „Unknown”</dc:rights></rdf:Description></rdf:RDF></metadata><mask id="viewboxMask"><rect width="1" height="1" rx="0" ry="0" fill="#fff" /></mask><g mask="url(#viewboxMask)"><g transform="rotate(360 0.5 0.5)"><defs></defs></g></g></svg>',
    );
  });
  ...
  it('toJson', () => {
    ...
    assert.strictEqual(
      avatar.toJson(),
      `{"svg":"<svg xmlns=\\"http://www.w3.org/2000/svg\\" viewBox=\\"0 0 100 100\\"><metadata xmlns:rdf=\\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\\" xmlns:xsi=\\"http://www.w3.org/2001/XMLSchema-instance\\" xmlns:dc=\\"http://purl.org/dc/elements/1.1/\\" xmlns:dcterms=\\"http://purl.org/dc/terms/\\"><rdf:RDF><rdf:Description><dc:title>DiceBear</dc:title><dc:creator>DiceBear</dc:creator><dc:source xsi:type=\\"dcterms:URI\\">https://www.dicebear.com</dc:source><dcterms:license xsi:type=\\"dcterms:URI\\">https://creativecommons.org/publicdomain/zero/1.0/</dcterms:license><dc:rights>„DiceBear” (https://www.dicebear.com) by „DiceBear”, licensed under „CC0 1.0” (https://creativecommons.org/publicdomain/zero/1.0/)</dc:rights></rdf:Description></rdf:RDF></metadata><mask id=\\"viewboxMask\\"><rect width=\\"100\\" height=\\"100\\" rx=\\"0\\" ry=\\"0\\" fill=\\"#fff\\" /></mask><g mask=\\"url(#viewboxMask)\\"><rect fill=\\"rgba(42, 126, 126, 1)\\" width=\\"100\\" height=\\"100\\" /><g transform=\\"rotate(360 50 50)\\"><defs><linearGradient id=\\"color-text\\"><stop stop-color=\\"rgba(255, 255, 255, 1)\\"/></linearGradient></defs><text x=\\"50%\\" y=\\"50%\\" font-family=\\"system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', 'Noto Sans', 'Liberation Sans', Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji'\\" font-size=\\"50\\" fill=\\"url(#color-text)\\" text-anchor=\\"middle\\" dy=\\"17.8\\">JD</text></g></g></svg>","metadata":{"license":{"name":"CC0 1.0","url":"https://creativecommons.org/publicdomain/zero/1.0/"},"creator":{"name":"DiceBear","url":"https://www.dicebear.com"},"source":{"name":"DiceBear","url":"https://www.dicebear.com"}},"properties":[["initials","JD"],["seed","John Doe"],["flip",false],["rotate",360],["scale",100],["radius",0],["size",null],["backgroundColor","#2a7e7eff"],["translateX",0],["translateY",0],["clip",true],["randomizeIds",false],["textColor","#ffffffff"]]}`,
    );
  });
});
