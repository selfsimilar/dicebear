...
import definition from "@dicebear/definitions/src/lorelei.json" with {
    type: "json"
};
...
const lorelei = createStyle<LoreleiOptions>(definition as Definition);
