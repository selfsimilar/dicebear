...
import definition from '@dicebear/definitions/src/bottts.json' with { type: 'json' };

interface BotttsOptions {
  eyes?: Array<
    | 'bulging'
    | 'dizzy'
    | 'eva'
...
const bottts = createStyle<BotttsOptions>(definition as StyleDefinition);
