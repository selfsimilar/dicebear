...
import definition from "@dicebear/definitions/src/big-ears-neutral.json" with {
    type: "json"
};

type BigEarsNeutralOptions = {
...
const bigEarsNeutral = createStyle<BigEarsNeutralOptions>(definition as Definition);
