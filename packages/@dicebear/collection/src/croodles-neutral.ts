...
import definition from "@dicebear/definitions/croodles-neutral.json" with {
    type: "json"
};
...
const croodlesNeutral = createStyle<CroodlesNeutralOptions>(definition as StyleDefinition);
