...
import definition from "@dicebear/definitions/src/croodles-neutral.json" with {
    type: "json"
};

type CroodlesNeutralOptions = {
...
const croodlesNeutral = createStyle<CroodlesNeutralOptions>(definition as Definition);
