...
import definition from "@dicebear/definitions/src/open-peeps.json" with {
    type: "json"
};

type OpenPeepsOptions = {
...
const openPeeps = createStyle<OpenPeepsOptions>(definition as Definition);
