...
import definition from "@dicebear/definitions/src/lorelei-neutral.json" with {
    type: "json"
};

type LoreleiNeutralOptions = {
...
const loreleiNeutral = createStyle<LoreleiNeutralOptions>(definition as Definition);
