...
import definition from "@dicebear/definitions/notionists-neutral.json" with {
    type: "json"
};

interface NotionistsNeutralOptions {
...
const notionistsNeutral = createStyle<NotionistsNeutralOptions>(definition as StyleDefinition);
